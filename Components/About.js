  ...
  return (
    <div className="section-container flex flex-col">
      <div className="mx-auto p-6 my-5 md:mt-20">
        <h2 className="font-black text-2xl tracking-widest text-veryDarkBlue">Who am I</h2>
      </div>
      <div className="mx-auto p-6 tracking-wide max-w-6xl text-grayishBlue text-base md:text-lg">
        <p className=" my-4 text-3xl font-bold text-teal-300 font-serif leading-9">
        ...
        <p className="my-4">
          When I'm not coding you'll catch me watching my favorite football club
          Arsenal's game or chatting with friends on all things sports or life
          in general. A fan of music as well when coding especially when it
          comes to designing a project or website.
        </p>
        <p>
          ...
          role. Interested in the entire fullstack spectrum and looking forward
          to working on/with amazing projects and positive people.
        </p>
      </div>
    </div>
  );
